...
#define DEFAULT_WALLPAPERS_DIR tzplatform_mkpath(TZ_SYS_RO_APP, "org.tizen.setting/shared/res/settings/Wallpapers/%s")
...
static Evas_Object *main_gengrid_add(Evas_Object *parent, void *data)
{
	...
	if (count > 0) {
		for (i = 0; i < count; i++) {
			...
			snprintf(string, sizeof(string), DEFAULT_WALLPAPERS_DIR, temp);
